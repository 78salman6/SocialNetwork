...
<body>
                ...
                <div class="collapse navbar-collapse" id="navcol-1">
                    ...
                    <ul class="nav navbar-nav hidden-xs hidden-sm navbar-right">
                        ...
                        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" href="#">User <span class="caret"></span></a>
                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                <li role="presentation"><a href="my-account.php">My Profile</a></li>
                                <li class="divider" role="presentation"></li>
                                <li role="presentation"><a href="#">Timeline </a></li>
                                <li role="presentation"><a href="messages.html">Messages </a></li>
                                <li role="presentation"><a href="notify.php">Notifications</a></li>
                ...
                <div class="col-md-3">
                    <ul class="list-group">
                        <li class="list-group-item"><span><strong>About Me</strong></span>
                            <p>Welcome to my profile.My name is <strong><?php echo $username ?></strong>.I am interested in coding.;</p>
                        </li>
                    </ul>
                </div>
                <div class="col-md-6">
    ...
    <div class="footer-dark">
        <footer>
            <div class="container">
                <p class="copyright">Salman Kashif@2017</p>
            </div>
        </footer>
    </div>
                                    ...
                                    success: function(r) {
                                            ...
                                            $.each(posts, function(index) {
                                                    ...
                                                    $('[data-id]').click(function() {
                                                            ...
                                                            $.ajax({
                                                                    //echo "Here it is working fine <br/>"
                                                                    type: "POST",
