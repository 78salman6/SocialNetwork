...
echo json_encode($messages);
  ...
  if ($_GET['url'] == "auth") {
          //echo "I have come here <b/>";
          $postBody = file_get_contents("php://input");
          $postBody = json_decode($postBody);
          //echo "Postbody=".$postBody."<b/>";
